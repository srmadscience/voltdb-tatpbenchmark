...
for MODE in FKMODE_CACHED_ANSWER MULTI_QUERY_FIRST ALL_PARTITIONS_TASKED ALL_PARTITIONS_FIRST
do
...
do
	...
	then
		...
		for OF in MULTI_QUERY_FIRST ALL_PARTITIONS_TASKED ALL_PARTITIONS_FIRST
		do
